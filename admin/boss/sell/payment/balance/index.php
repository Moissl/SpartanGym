...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO invoices (userid, name, price, type, payment_method, status, route, created_at, description) VALUES (?, ?, ?, 'Balance', ?, ?, ?, NOW(), ?)");
    $stmt->bind_param("isdssss", $userid, $fullname, $amount, $dbPaymentMethod, $status, $pathinvoicesql, $description);
