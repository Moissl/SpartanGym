...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    } elseif ($product['barcode'] !== $barcode) {
        // Rename existing image if barcode changed and no new image uploaded
        $old_file = $target_dir . $product['barcode'] . ".png";
        $new_file = $target_dir . $barcode . ".png";
