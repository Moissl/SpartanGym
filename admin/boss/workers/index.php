            ...
            <div class="col-sm-2 sidenav hidden-xs text-center">
                ...
                <ul class="nav nav-pills nav-stacked">
                    ...
                    ?>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="timeclock.php">
            ...
            <div class="col-sm-10">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <?php 
                        echo $alerts_html;
                        if (isset($_SESSION['qr_message'])) {
                            echo '<div class="alert alert-success">' . $_SESSION['qr_message'] . '</div>';
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                ...
                                if ($is_boss == 1) {
                                    echo '<div class="mb-3">';
                                    echo '<a href="generate_qr.php" class="btn btn-info"><i class="bi bi-qr-code"></i> Generar/Actualizar QRs</a> ';
                                    echo '<a href="view_qrs.php" class="btn btn-primary"><i class="bi bi-images"></i> Ver QRs</a> ';
                                    echo '<a href="download_qrs.php" class="btn btn-success"><i class="bi bi-download"></i> Descargar ZIP</a>';
                                    echo '</div>';
                                ?>
                                            ...
                                            <tbody>
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) {
                                                        $qr_file = __DIR__ . "/../../../assets/img/worker_qr/{$row['userid']}.png";
                                ...
                                <td>";
                                                        if ($has_qr) {
                                                            echo '<img src="../../assets/img/worker_qr/' . $row['userid'] . '.png" alt="QR" style="width: 80px; height: 80px;">';
                                                        } else {
