...
if (isset($_GET['msg'])) {
    if ($_GET['msg'] == 'deleted') {
        ...
        $delete_message = "Error al eliminar registros.";
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <?php if (isset($delete_message)) : ?>
                                    <div class="alert <?php echo isset($alert_class) ? $alert_class : 'alert-info'; ?>"><?php echo htmlspecialchars($delete_message, ENT_QUOTES, 'UTF-8'); ?></div>
                                <?php endif; ?>
                                <div class="table">
                                        ...
                                        <tbody>
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    $logTime = new DateTime($row['time'], new DateTimeZone('UTC'));
                                                    $logTime->setTimezone(new DateTimeZone('America/Mexico_City'));
                                                    ...
                                                    echo "<td>" . htmlspecialchars($logTime->format('Y-m-d H:i:s'), ENT_QUOTES, 'UTF-8') . "</td>";
                                                    echo "</tr>";
                                                }
                                            } else {
